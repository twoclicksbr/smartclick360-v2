                ...
                <div class="card mb-6" id="documents_card">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-semibold fs-7" id="documents_subtitle">
                                Carregando...
                            </span>
                        </h3>
                        <div class="card-toolbar">
                ...
                <div class="card mb-6" id="addresses_card">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-semibold fs-7" id="addresses_subtitle">
                                Carregando...
                            </span>
                        </h3>
                        <div class="card-toolbar">
                ...
                <div class="card mb-6" id="notes_card">
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="table-responsive" style="overflow-x: visible;">
                            <!--begin::Table-->
                            <table class="table align-middle gs-0 gy-3" id="notes_list" style="table-layout: fixed;">
                                <colgroup>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-flush mb-5">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <!--end::Stats-->
                                <!--begin::Chart-->
                                <div id="kt_payables_chart" class="card-rounded-bottom"
                                    style="height: 150px; min-height: 150px;"></div>
                                <!--end::Chart-->
                            </div>
                            <!--end::Card body-->
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-flush mb-5">
                            ...
                            <div class="card-body d-flex flex-column p-0">
                                ...
                                <!--end::Stats-->
                                <!--begin::Chart-->
                                <div id="kt_receivables_chart" class="card-rounded-bottom"
                                    style="height: 150px; min-height: 150px;"></div>
                                <!--end::Chart-->
                            </div>
                            <!--end::Card body-->
        ...
        <script>
            ...
            function populatePersonPage(person) {
                ...
                if (navEditBtn) {
                    ...
                    navEditBtn.onclick = function() {
                        editPerson(person.id, person.first_name, person.surname, birthDateFormatted, avatarUrl, person
                            .status);
                    };
                }
                ...
                document.getElementById('contacts_subtitle').innerHTML =
                    `${contactsCount} ${contactsCount === 1 ? 'contato' : 'contatos'} cadastrado${contactsCount === 1 ? '' : 's'}`;
                document.getElementById('addresses_subtitle').innerHTML =
                    `${addressesCount} ${addressesCount === 1 ? 'endereço' : 'endereços'} cadastrado${addressesCount === 1 ? '' : 's'}`;
                document.getElementById('documents_subtitle').innerHTML =
                    `${documentsCount} ${documentsCount === 1 ? 'documento' : 'documentos'} cadastrado${documentsCount === 1 ? '' : 's'}`;
                document.getElementById('notes_subtitle').innerHTML =
                    `${notesCount} ${notesCount === 1 ? 'observação' : 'observações'} cadastrada${notesCount === 1 ? '' : 's'}`;
            ...
            function populateContactsList(contacts) {
                ...
                if (contacts.length === 0) {
                    container.innerHTML =
                        '<tr><td colspan="3" class="text-center text-gray-500 py-5">Nenhum contato cadastrado</td></tr>';
                    return;
                }
                ...
                contacts.forEach(contact => {
                    ...
                    const formattedValue = (typeName === 'WhatsApp' || typeName === 'Telefone' || typeName ===
                            'Celular') ?
                        formatPhone(contact.value) :
                        contact.value;

                    // Define botões de ação (esconde se pessoa está deletada)
                    const actionButtons = window.isPersonDeleted ? '' : `
                        <a href="#" onclick="editContact(${contact.id}); return false;" class="btn btn-icon btn-sm btn-light-primary me-1">
                            <i class="ki-outline ki-pencil fs-2"></i>
                        </a>
                        <a href="#" onclick="deleteContact(${contact.id}); return false;" class="btn btn-icon btn-sm btn-light-danger">
            ...
            function populateAddressesList(addresses) {
                ...
                if (addresses.length === 0) {
                    container.innerHTML =
                        '<tr><td colspan="3" class="text-center text-gray-500 py-5">Nenhum endereço cadastrado</td></tr>';
                    return;
                }
                ...
                addresses.forEach(address => {
                    ...
                    // Define botões de ação (esconde se pessoa está deletada)
                    const actionButtons = window.isPersonDeleted ? '' : `
                        <a href="#" onclick="editAddress(${address.id}); return false;" class="btn btn-icon btn-sm btn-light-primary me-1">
                            <i class="ki-outline ki-pencil fs-2"></i>
                        </a>
                        <a href="#" onclick="deleteAddress(${address.id}); return false;" class="btn btn-icon btn-sm btn-light-danger">
                            <i class="ki-outline ki-trash fs-2"></i>
                        </a>
                    `;
                    ...
                    <tr data-address-id="${address.id}">
                        ...
                        <td>
                            <span class="text-gray-900 fw-bold mb-1 fs-6">
                                ${typeName}
                                ${address.is_main ? '<span class="badge badge-light-success ms-2">Principal</span>' : ''}
                            </span>
            ...
            function populateDocumentsList(documents) {
                ...
                if (documents.length === 0) {
                    container.innerHTML =
                        '<tr><td colspan="3" class="text-center text-gray-500 py-5">Nenhum documento cadastrado</td></tr>';
                    return;
                }
                ...
                documents.forEach(doc => {
                    ...
                    // Define botões de ação (esconde se pessoa está deletada)
                    const actionButtons = window.isPersonDeleted ? '' : `
                        <a href="#" onclick="editDocument(${doc.id}); return false;" class="btn btn-icon btn-sm btn-light-primary me-1">
                            <i class="ki-outline ki-pencil fs-2"></i>
                        </a>
                        <a href="#" onclick="deleteDocument(${doc.id}); return false;" class="btn btn-icon btn-sm btn-light-danger">
                            <i class="ki-outline ki-trash fs-2"></i>
                        </a>
                    `;
            ...
            function populateNotesList(notes) {
                ...
                notes.forEach(note => {
                    ...
                    // Define botões de ação (esconde se pessoa está deletada)
                    const actionButtons = window.isPersonDeleted ? '' : `
                        <a href="#" onclick="editNote(${note.id}); return false;" class="btn btn-icon btn-sm btn-light-primary me-1">
                            <i class="ki-outline ki-pencil fs-2"></i>
                        </a>
                        <a href="#" onclick="deleteNote(${note.id}); return false;" class="btn btn-icon btn-sm btn-light-danger">
                            <i class="ki-outline ki-trash fs-2"></i>
                        </a>
                    `;
                    ...
                    <tr data-note-id="${note.id}">
                        ...
                        <td>
                            <div class="d-flex flex-column" style="min-width: 0;">
                                <span class="text-gray-900 fw-bold fs-6 text-truncate d-block ${note.status ? '' : 'text-muted'}">${note.content || ''}</span>
                                <span class="text-muted fw-semibold fs-7">
                                    <i class="ki-outline ki-calendar fs-7 me-1"></i>${createdAt}
                                    ${!note.status ? '<span class="badge badge-light-danger ms-2">Inativo</span>' : ''}
                                </span>
                            </div>
                        </td>
                        <td class="text-end">
                ...
                const subtitle = document.getElementById('notes_subtitle');
                if (subtitle) {
                    subtitle.textContent = notesCount === 1 ? '1 observação cadastrada' :
                        `${notesCount} observações cadastradas`;
                }
            }
                    ...
                    fetch(url, {
                        ...
                        .then(data => {
                            ...
                            `;
                                ...
                                // Só atualiza a tabela se ela existir (se estiver na aba de endereços)
                                if (!container) {
                                    // Fecha modal e mostra success
                                    var modal = bootstrap.Modal.getInstance(addressModal);
                                    modal.hide();
                                    toastr.success(data.message);
                                    addressForm.reset();

                                    // Remove backdrop manualmente (bugfix do Bootstrap)
                                ...
                                // Se o novo endereço foi marcado como principal, remove badge dos outros
                                if (address.is_main) {
                                    const allAddressCards = container.querySelectorAll('tr[data-address-id]');
                                    allAddressCards.forEach(card => {
                                        const badge = card.querySelector('.badge.badge-light-success');
                                        if (badge) {
                                            badge.remove();
                                        }
                                    });
                                ...
                                if (isEdit) {
                                    // Se foi marcado como principal, remove badge dos outros
                                    if (address.is_main) {
                                        const allAddressCards = container.querySelectorAll('tr[data-address-id]');
                                        allAddressCards.forEach(card => {
                                            const cardId = card.getAttribute('data-address-id');
                                            if (cardId != address.id) { // diferente do atual
                                    ...
                                    // Se for principal, insere no início; caso contrário, insere no final
                                    if (address.is_main) {
                                    ...
                                    // Inserir novo card
                                    // Remove mensagem "Nenhum endereço cadastrado" se existir
                                    const noDataRow = container.querySelector('tr td[colspan="3"]');
                                    if (noDataRow) {
                                    ...
                                    const subtitle = document.getElementById('addresses_subtitle');
                                    if (subtitle) {
                                        const currentCount = container.querySelectorAll('tr[data-address-id]')
                                            .length;
                                        subtitle.textContent = currentCount === 1 ? '1 endereço cadastrado' :
                                            `${currentCount} endereços cadastrados`;
                                    }
                                }
                                ...
                                // Remover backdrop manualmente (bugfix do Bootstrap)
                                document.querySelectorAll('.modal-backdrop').forEach(el => el.remove());
                                document.body.classList.remove('modal-open');
                                document.body.style.removeProperty('padding-right');
                            } else {
            ...
            function addAddress() {
                ...
                const addressesListBody = document.getElementById('addresses_list_tbody');
                const hasMainAddress = addressesListBody && addressesListBody.querySelector('[data-address-id]') !== null;

                // Se não existir nenhum endereço, marca como principal automaticamente
                const isMainCheckbox = document.getElementById('address_is_main');
                if (isMainCheckbox) {
                    isMainCheckbox.checked = !hasMainAddress; // true se for o primeiro, false caso contrário
                }
                                ...
                                if (data.success) {
                                    if (isEditing) {
                                        ...
                                        if (row) {
                                            ...
                                            <td>
                                                <div class="d-flex flex-column" style="min-width: 0;">
                                                    <span class="text-gray-900 fw-bold fs-6 text-truncate d-block ${inactiveClass}">${data.note.content || ''}</span>
                                                    <span class="text-muted fw-semibold fs-7">
                                                        <i class="ki-outline ki-calendar fs-7 me-1"></i>${createdAt}
                                                        ${inactiveBadge}
                                                    </span>
                                        ...
                                        <tr data-note-id="${data.note.id}">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column" style="min-width: 0;">
                                                    <span class="text-gray-900 fw-bold fs-6 text-truncate d-block">${data.note.content || ''}</span>
                                                    <span class="text-muted fw-semibold fs-7">
                                                        <i class="ki-outline ki-calendar fs-7 me-1"></i>${createdAt}
                                                    </span>
                                                </div>
                ...
                var payablesChartOptions = {
                    ...
                    legend: {
                        ...
                        formatter: function(seriesName, opts) {
                            return seriesName + ': R$ ' + opts.w.globals.series[opts.seriesIndex].toLocaleString(
                                'pt-BR');
                        }
                    }
                };
