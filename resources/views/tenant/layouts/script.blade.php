...
@stack('scripts')
<!--begin::Custom Javascript - Help Modal-->
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (helpSearchInput) {
        helpSearchInput.addEventListener('input', function(e) {
            ...
            // Implementar busca nos itens do FAQ
            const faqItems = document.querySelectorAll('#kt_accordion_help_faq .accordion-header');
            faqItems.forEach(item => {
                const text = item.textContent.toLowerCase();
                const parent = item.closest('.mb-5');
