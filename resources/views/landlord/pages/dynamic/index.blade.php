            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_dynamic">
                    ...
                    <tbody class="text-gray-600 fw-semibold" id="kt_table_body">
                        @include('landlord.pages.dynamic._tbody', ['config' => $config, 'indexFields' => $indexFields, 'records' => $records, 'module' => $module])
                    </tbody>
                </table>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initActions() {
        // NOTA: O código do botão editar está no _modal.blade.php (linhas 195-219)
